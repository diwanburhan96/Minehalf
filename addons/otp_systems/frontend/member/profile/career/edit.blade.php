<form action="{{ route('career.update', $career->id) }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="hidden" name="career_start" value="0" class="form-control" placeholder="{{translate('Year Of Joining')}}" required>
            </div>
        </div>
        <div class="form-group row">
            
            <div class="col-md-9">
                <input type="hidden" name="career_end" value="0"  placeholder="{{ translate(' To') }}" class="form-control" required>
            </div>
        </div>
    </div>
