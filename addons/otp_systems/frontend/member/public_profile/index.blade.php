...
@section('content')
            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-3">
                    <div class="px-0 row align-items-center">
                        <div class="col-md-7 col-xxl-9">
                            ...
                            <div class="fs-18">
                                <span class="ml-2">{{ translate('Member ID: ') }}</span>
                                <span class="ml-2">{{ $user->code }}</span>
                                @if ( $user->verify == 1)
                                <img src="{{ static_asset('assets/img/v11.png') }}"
                                    class="size-20px rounded-circle img-fit mr-2" title="Verified Profile">
                                @endif
                            </div>
                        ...
                        <div class="col-md-5 col-xxl-3">
                            ...
                            @if (Auth::user()->id != $user->id)
                                <div class="py-0 text-center border-md-left border-gray-600">
                            ...
                            @if (Auth::user()->id != $user->id)
                            <div class="row">
                                <div class="col-lg py-1" title="{{ translate('Shortlist') }}">
                                    @php
                            ...
                            @endif
                            class="btn btn-block  btn-link text-white text-left">
                            <i class="las la-list d-block la-2x"></i>
                            <span id="shortlist_id_{{ $user->id }}">{{ $shortlist_text }}</span>
                            </a>
                        </div>                        
                        @endif							
                            <div class="col-lg py-1" title="{{ translate('Ignore') }}">
                            ...
                            <div class="col-lg py-1" title="{{ translate('Report') }}">
                                @php
                                ...
                                @endphp
                                <a href="" id="report_a_id_{{ $user->id }}" @if ($report_onclick == 1)
                ...
                <div class="mt-4">
                    <div class="nav nav-tabs aiz-nav-tabs bottom-bordered active-white border-0">
                        <a class="text-white d-inline-block fw-600 fs-15 px-3 py-2 active" data-toggle="tab"
                            href="#profile">{{ translate(' Profile Details') }}</a>
                        @if (get_setting('member_partner_expectation_section') == 'on')
                            <a class="text-white d-inline-block fw-600 fs-15 px-3 py-2" data-toggle="tab"
    ...
    <section class="py-0 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-xxl-3 order-1 order-xl-0">
                        ...
                        <div class="overflow-hidden position-relative rounded shadow-lg mb-4 bg-white d-none d-xl-block">
                            ...
                            @if ($user->photo != null && $user->photo_approved == 1 && $profile_pic_privacy == 'only_me' && ($photo_view_request == null || ($photo_view_request && $photo_view_request->status == 0)))
                                <button 
                                    ...
                                    @endif
                                    class="btn btn-block btn-primary border position-relative z-1"
                                    >
                                    @if($photo_view_request == null)
                                        {{ translate('Request Photo') }}
                    ...
                    @if (Auth::user()->member->auto_profile_match == 1)
                        <div class="mb-4">
                            ...
                            <div>
                                @foreach ($similar_profiles->shuffle()->take(10) as $similar_profile)
                        ...
                        <div class="accordion aiz-timeline-accordion " id="profile-accordion">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse"
                                    ...
                                    <div class="ml-4">
                                        <span
                                            class="fs-18 fw-600 d-block text-primary">{{ translate(' About ') }}</span>
                                        <span class="fs-11 fw-400">
                                            <span>{{ translate('Member ID: ') }} {{ $user->code }}</span>
                                            <span class="mx-2">|</span>
                                            <span>{{ translate('Manage By:') }}
                                                {{ $user->member->on_behalves->name }}</span>
                                        </span>
                                    </div>
                                </div>
            
                               @if ( $user->photo_approved == 1) 
                                ...
                                <div id="about" class="collapse show accordion-body ml-3 ml-md-5 pl-25px lh-1-8"
                                    data-parent="#profile-accordion">
                                    {{ translate(' Pending for admin Approval ') }}
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="pb-4 accordion-item">
                                ...
                                <div id="basic-info" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                    data-parent="#profile-accordion">
                                    <div class=" p-3">
                            ...
                            @if (get_setting('member_present_address_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="present-address" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class=" p-3">
                            ...
                            <div class="pb-4 accordion-item">
                                ...
                                <div id="contact-details" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                    data-parent="#profile-accordion">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class=" p-3">
                            ...
                            @if (get_setting('member_education_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="education" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                            ...
                            @if (get_setting('member_career_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="career" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                            ...
                            @if (get_setting('member_physical_attributes_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="physical-attributes" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-sm-6">
                            ...
                            @if (get_setting('member_language_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="language" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class=" p-3">
                            ...
                            @if (get_setting('member_hobbies_and_interests_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="hobby" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-12">
                            ...
                            <!--@if (get_setting('member_personal_attitude_and_behavior_section') == 'on')
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="personal-attitude" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-6">
                            ...
                            @if (get_setting('member_residency_information_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="residency-info" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-6">
                            ...
                            @if (get_setting('member_spiritual_and_social_background_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="spiritual-social" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-6">
                            ...
                            @if (get_setting('member_life_style_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="life-style" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-6">
                            ...
                            @if (get_setting('member_astronomic_information_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="astronomic" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-6">
                            ...
                            @if (get_setting('member_permanent_address_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="permanent-address" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                            ...
                            @if (get_setting('member_family_information_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    <div id="family-info" class="collapse accordion-body ml-3 ml-md-5 pl-25px show accordion-body"
                                        data-parent="#profile-accordion">
                                        <div class=" p-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-6">
                            ...
                            <div class="col-lg py-1">
                                ...
                                @endphp
                                <a href="avascript:void(0);" class="btn btn-block btn-primary" id="report_a_id_{{ $user->id }}" @if ($report_onclick == 1)
                                    onclick="report_member({{ $user->id }})"
                                    @endif
                                    <i class="las la-info-circle d-block la-2x"></i>
                                    <span id="report_id_{{ $user->id }}">{{ $report_text }}{{translate('Claim Your Free Package')}}</span>
                                </a>
                            </div>
                            @endif
...
@section('modal')
    ...
    <div class="modal fade report_modal" id="modal-zoom">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h6">{{ translate('Package Claim') }}</h5>
                    <button type="button" class="close" data-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('reportusers.store') }}" id="report-modal-form" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-9">
                                    <input type="hidden"  name="reason" value="0"  class="form-control">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                        onclick="submitReport()">{{ translate('Submit') }}</button>
                </div>
            </div>
        </div>
    </div>
