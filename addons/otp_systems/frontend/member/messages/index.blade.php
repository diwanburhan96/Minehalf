        ...
        <div class="row no-gutters">
                ...
                <div class="chat-user-list-wrap z-1035">
                    ...
                    <div class="chat-user-list border-right py-3 c-scrollbar-light">
                        @forelse ($chat_threads as $key => $single_chat_thread)
                            ...
                            @endphp
                            @if (Auth::user()->membership != 1 && $single_chat_thread->receiver != null && $single_chat_thread->sender != null)
            ...
            <div class="col-lg-8" id="single_chat">
                <div class="chat-box-wrap h-100">
                    ...
                    @else
                    <div class="px-3 py-5 text-center">
                        <i class="las la-exclamation-circle la-6x text-primary mb-4"></i>
                        
                        <h5>{{ translate('Upgrade Your Membership to send and view  Message!') }}</h5>
