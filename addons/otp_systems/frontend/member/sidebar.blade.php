        ...
        <div class="sidemnenu mb-3">
            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                    ...
                    <a href="{{ route('gallery-image.index') }}" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Gallery Image') }}</span>
                    </a>
                    </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('member_profile', Auth::user()->id) }}" class="aiz-side-nav-link">
                            <i class="las la-shopping-basket aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Claim Your Free Package') }}</span>
                    </a>
                </li>
                <!--<li class="aiz-side-nav-item">
